...
public class TessUConfig {
    ...
    public static boolean enableVanillaNightVis = false;
    public static boolean enableFuzzyExtruder = false;

    public static float reach = 5;
    public static float flySpeed = 2;
    public static float extrudeLimit = 128;
    ...
    public static void loadConfig() {
        ...
        try {
            ...
            enableVanillaNightVis = Boolean.parseBoolean(properties.getProperty("EnableVanillaNightVis"));
            enableFuzzyExtruder = Boolean.parseBoolean(properties.getProperty("EnableFuzzyExtruder"));

            reach = Float.parseFloat(properties.getProperty("CreativeReach"));
            flySpeed = Float.parseFloat(properties.getProperty("FlySpeed"));
            extrudeLimit = Float.parseFloat(properties.getProperty("ExtrudeLimit"));
    ...
    public static void saveConfig() {
        ...
        properties.setProperty("EnableVanillaNightVis",String.valueOf(enableVanillaNightVis));
        properties.setProperty("EnableFuzzyExtruder",String.valueOf(enableFuzzyExtruder));

        properties.setProperty("CreativeReach", String.valueOf(reach));
        properties.setProperty("FlySpeed", String.valueOf(flySpeed));
        properties.setProperty("ExtrudeLimit", String.valueOf(extrudeLimit));
